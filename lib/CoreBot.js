        ...
        botkit.middleware.receive.run(bot, message, function(err, bot, message) {
            if (err) {
                ...
                bot.findConversation(message, function(convo) {
                    if (convo) {
                        botkit.debug('convo found');
                        convo.handle(message);
                    } else {
                        botkit.debug('convo not found');
    ...
    function Conversation(task, message) {
        ...
        this.gotoThread = function(thread) {
            ...
            var makeChange = function() {
                ...
                botkit.middleware.conversationChange.run(that, that, function() {
                    botkit.debug('convo conversation change middleware');
                });
            };
